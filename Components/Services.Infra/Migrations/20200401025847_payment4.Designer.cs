...
namespace Services.Infra.Migrations
{
    ...
    [Migration("20200401025847_payment4")]
            ...
            modelBuilder.Entity("Services.Domain.Entities.AirPlane", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "1",
                            CreationDate = new DateTime(2020, 3, 31, 23, 58, 46, 355, DateTimeKind.Local).AddTicks(4327),
                        ...
                        new
                        {
                            ...
                            Code = "3B",
                            CreationDate = new DateTime(2020, 3, 31, 23, 58, 46, 360, DateTimeKind.Local).AddTicks(1002),
                        ...
                        new
                        {
                            ...
                            Code = "4",
                            CreationDate = new DateTime(2020, 3, 31, 23, 58, 46, 360, DateTimeKind.Local).AddTicks(1096),
            ...
            modelBuilder.Entity("Services.Domain.Entities.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PaidDate = new DateTime(2020, 3, 31, 23, 58, 46, 367, DateTimeKind.Local).AddTicks(147)
                        });
                });
