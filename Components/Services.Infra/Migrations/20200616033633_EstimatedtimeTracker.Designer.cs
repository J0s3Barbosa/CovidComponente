...
namespace Services.Infra.Migrations
{
    ...
    [Migration("20200616033633_EstimatedtimeTracker")]
    partial class EstimatedtimeTracker
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Services.Domain.Entities.AirPlane", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "1",
                            CreationDate = new DateTime(2020, 6, 16, 0, 36, 31, 622, DateTimeKind.Local).AddTicks(3878),
                        ...
                        new
                        {
                            ...
                            Code = "3B",
                            CreationDate = new DateTime(2020, 6, 16, 0, 36, 31, 623, DateTimeKind.Local).AddTicks(5847),
                        ...
                        new
                        {
                            ...
                            Code = "4",
                            CreationDate = new DateTime(2020, 6, 16, 0, 36, 31, 623, DateTimeKind.Local).AddTicks(5944),
            ...
            modelBuilder.Entity("Services.Domain.Entities.Article", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("eeac3b20-d971-43eb-be8f-fedca06e9315"),
                            Access = 1,
            ...
            modelBuilder.Entity("Services.Domain.Entities.EstimatedtimeTracker", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("EstimatedtimeTracker");

                    b.HasData(
                        new
                        {
                            Id = new Guid("f9cb274a-e3f9-42c0-88ff-f50c4eecb01f"),
                            Activity = "Activity",
                            Date = "6/16/2020 12:36:31 AM",
                            Owner = "Email@Email.com",
                            Project = "Project",
                            TimeEnded = "02:36:31",
                            TimeSpent = "00:36:3102:36:31",
                            TimeStarted = "00:36:31"
                        });
                });
            ...
            modelBuilder.Entity("Services.Domain.Entities.HealthCheck", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("988a0de6-0dc3-4154-ae78-d138dba466f4"),
                            AppName = "API",
                            TimeAccessed = "6/16/2020 12:36:31 AM"
                        });
                });
            ...
            modelBuilder.Entity("Services.Domain.Entities.Todo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("774993cb-b2e9-4366-95ba-362f6ea4cecf"),
                            Description = "Description",
                            Details = "Details",
                            TaskComplete = false,
                            TimeFinished = "6/16/2020 2:36:31 AM",
                            TimeStarted = "6/16/2020 12:36:31 AM",
                            UserEmail = "Email@Email.com"
                        });
                });
            ...
            modelBuilder.Entity("Services.Domain.Entities.VideoPlayer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0df8a077-5929-4a8f-b1ea-1b31cd9831f5"),
                            Description = "Description",
