...
namespace Services.Infra.Migrations
{
    ...
    [Migration("20200529023902_userEmailPayment")]
    partial class userEmailPayment
    {
            ...
            modelBuilder.Entity("Services.Domain.Entities.AirPlane", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "1",
                            CreationDate = new DateTime(2020, 5, 28, 23, 39, 1, 241, DateTimeKind.Local).AddTicks(8659),
                        ...
                        new
                        {
                            ...
                            Code = "3B",
                            CreationDate = new DateTime(2020, 5, 28, 23, 39, 1, 242, DateTimeKind.Local).AddTicks(6505),
                        ...
                        new
                        {
                            ...
                            Code = "4",
                            CreationDate = new DateTime(2020, 5, 28, 23, 39, 1, 242, DateTimeKind.Local).AddTicks(6567),
            ...
            modelBuilder.Entity("Services.Domain.Entities.HealthCheck", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("35051663-b19e-45ac-b24d-b328142585bb"),
                            AppName = "API",
                            TimeAccessed = "5/28/2020 11:39:01 PM"
                        });
                });
            ...
            modelBuilder.Entity("Services.Domain.Entities.Todo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("22a6ff52-5717-4715-842b-6299ed2f343d"),
                            Description = "Description",
                            Details = "Details",
                            TaskComplete = false,
                            TimeFinished = "5/29/2020 1:39:01 AM",
                            TimeStarted = "5/28/2020 11:39:01 PM",
            ...
            modelBuilder.Entity("Services.Domain.Entities.VideoPlayer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("46367111-2335-4e97-b4bb-95fdaa7c42c3"),
                            Description = "Description",
