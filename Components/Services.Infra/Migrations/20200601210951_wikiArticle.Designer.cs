...
namespace Services.Infra.Migrations
{
    ...
    [Migration("20200601210951_wikiArticle")]
    partial class wikiArticle
    {
            ...
            modelBuilder.Entity("Services.Domain.Entities.AirPlane", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "1",
                            CreationDate = new DateTime(2020, 6, 1, 18, 9, 50, 439, DateTimeKind.Local).AddTicks(929),
                        ...
                        new
                        {
                            ...
                            Code = "3B",
                            CreationDate = new DateTime(2020, 6, 1, 18, 9, 50, 442, DateTimeKind.Local).AddTicks(286),
                        ...
                        new
                        {
                            ...
                            Code = "4",
                            CreationDate = new DateTime(2020, 6, 1, 18, 9, 50, 442, DateTimeKind.Local).AddTicks(408),
            ...
            modelBuilder.Entity("Services.Domain.Entities.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("21a7a844-f300-41bb-99f1-5b861c2d0190"),
                            Access = 1,
            ...
            modelBuilder.Entity("Services.Domain.Entities.HealthCheck", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0ae72dad-47f0-45cb-a289-6334a40ad127"),
                            AppName = "API",
                            TimeAccessed = "6/1/2020 6:09:50 PM"
                        });
                });
            ...
            modelBuilder.Entity("Services.Domain.Entities.Todo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("233837f4-60a9-4732-a41b-7bf537ae1d08"),
                            Description = "Description",
                            Details = "Details",
                            TaskComplete = false,
                            TimeFinished = "6/1/2020 8:09:50 PM",
                            TimeStarted = "6/1/2020 6:09:50 PM",
                            UserEmail = "Email@Email.com"
                        });
                });
            ...
            modelBuilder.Entity("Services.Domain.Entities.VideoPlayer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5e45e467-e9e7-42a4-92d4-03adf8584033"),
                            Description = "Description",
