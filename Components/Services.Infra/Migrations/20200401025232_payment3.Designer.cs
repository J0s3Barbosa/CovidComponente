...
namespace Services.Infra.Migrations
{
    ...
    [Migration("20200401025232_payment3")]
            ...
            modelBuilder.Entity("Services.Domain.Entities.AirPlane", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "1",
                            CreationDate = new DateTime(2020, 3, 31, 23, 52, 31, 274, DateTimeKind.Local).AddTicks(7462),
                        ...
                        new
                        {
                            ...
                            Code = "3B",
                            CreationDate = new DateTime(2020, 3, 31, 23, 52, 31, 282, DateTimeKind.Local).AddTicks(6892),
                        ...
                        new
                        {
                            ...
                            Code = "4",
                            CreationDate = new DateTime(2020, 3, 31, 23, 52, 31, 282, DateTimeKind.Local).AddTicks(7001),
            ...
            modelBuilder.Entity("Services.Domain.Entities.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BarCode = "1",
                            Description = "Rent",
                            DueDate = new DateTime(2020, 5, 4, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PaidDate = new DateTime(2020, 3, 31, 23, 52, 31, 294, DateTimeKind.Local).AddTicks(6359)
                        });
                });
