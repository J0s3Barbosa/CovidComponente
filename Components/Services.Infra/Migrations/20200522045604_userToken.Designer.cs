...
namespace Services.Infra.Migrations
{
    ...
    [Migration("20200522045604_userToken")]
            ...
            modelBuilder.Entity("Services.Domain.Entities.AirPlane", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "1",
                            CreationDate = new DateTime(2020, 5, 22, 1, 56, 2, 745, DateTimeKind.Local).AddTicks(4859),
                        ...
                        new
                        {
                            ...
                            Code = "3B",
                            CreationDate = new DateTime(2020, 5, 22, 1, 56, 2, 746, DateTimeKind.Local).AddTicks(5520),
                        ...
                        new
                        {
                            ...
                            Code = "4",
                            CreationDate = new DateTime(2020, 5, 22, 1, 56, 2, 746, DateTimeKind.Local).AddTicks(5589),
            ...
            modelBuilder.Entity("Services.Domain.Entities.HealthCheck", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("dd31b634-4d09-4634-be26-78daee23f160"),
                            AppName = "API",
                            TimeAccessed = "5/22/2020 1:56:02 AM"
                        });
                });
            ...
            modelBuilder.Entity("Services.Domain.Entities.Todo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7bf72486-bd35-4213-9287-a25168421c49"),
                            Description = "Description",
                            Details = "Details",
                            TaskComplete = false,
                            TimeFinished = "5/22/2020 3:56:02 AM",
                            TimeStarted = "5/22/2020 1:56:02 AM",
            ...
            modelBuilder.Entity("Services.Domain.Entities.VideoPlayer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d5bb1ba4-7742-4930-a2fe-b03a3959a128"),
                            Description = "Description",
