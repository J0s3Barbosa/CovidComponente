...
namespace Services.Infra.Migrations
{
    ...
    [Migration("20200401014048_payment2")]
            ...
            modelBuilder.Entity("Services.Domain.Entities.AirPlane", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "1",
                            CreationDate = new DateTime(2020, 3, 31, 22, 40, 47, 262, DateTimeKind.Local).AddTicks(9802),
                        ...
                        new
                        {
                            ...
                            Code = "3B",
                            CreationDate = new DateTime(2020, 3, 31, 22, 40, 47, 267, DateTimeKind.Local).AddTicks(2299),
                        ...
                        new
                        {
                            ...
                            Code = "4",
                            CreationDate = new DateTime(2020, 3, 31, 22, 40, 47, 267, DateTimeKind.Local).AddTicks(2390),
            ...
            modelBuilder.Entity("Services.Domain.Entities.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PaidDate = new DateTime(2020, 3, 31, 22, 40, 47, 273, DateTimeKind.Local).AddTicks(7369)
                        });
                });
