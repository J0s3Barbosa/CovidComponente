...
namespace Services.Infra.Migrations
{
    ...
    [Migration("20200331210536_payment")]
            ...
            modelBuilder.Entity("Services.Domain.Entities.AirPlane", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "1",
                            CreationDate = new DateTime(2020, 3, 31, 18, 5, 35, 782, DateTimeKind.Local).AddTicks(5418),
                        ...
                        new
                        {
                            ...
                            Code = "3B",
                            CreationDate = new DateTime(2020, 3, 31, 18, 5, 35, 786, DateTimeKind.Local).AddTicks(8266),
                        ...
                        new
                        {
                            ...
                            Code = "4",
                            CreationDate = new DateTime(2020, 3, 31, 18, 5, 35, 786, DateTimeKind.Local).AddTicks(8397),
            ...
            modelBuilder.Entity("Services.Domain.Entities.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PaidDate = new DateTime(2020, 3, 31, 18, 5, 35, 799, DateTimeKind.Local).AddTicks(6973)
                        });
                });
